...
from Config.Exceptions import BadCommandUsage, musicError, ErrorRemoving, InvalidInput, NumberRequired
...
class RemoveHandler(AbstractHandler):
    ...
    def __validateInput(self, position: str) -> Union[musicError, None]:
        try:
