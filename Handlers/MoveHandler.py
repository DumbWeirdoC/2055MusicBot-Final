...
from Config.Exceptions import BadCommandUsage, musicError, InvalidInput, NumberRequired, UnknownError
...
class MoveHandler(AbstractHandler):
    ...
    def __validateInput(self, pos1: str, pos2: str) -> Union[musicError, None]:
        try:
            pos1 = int(pos1)
            pos2 = int(pos2)
        except:
