...
class Helper(Singleton):
    def __init__(self) -> None:
        if not super().created:
            ...
            self.HELP_STOP_LONG = 'Stop the song player, clear queue and history and remove 2055-Music from voice channel.\n\nArguments: None.'
            ...
            self.HELP_INVITE = 'Send the invite URL to call 2055-Music to your server.'
            self.HELP_INVITE_LONG = 'Send an message in text channel with a URL to be used to invite 2055-Music to your own server.\n\nArguments: None.'
