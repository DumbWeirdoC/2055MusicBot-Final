...
class Messages(Singleton):
    def __init__(self) -> None:
        if not super().created:
            ...
            configs = VConfigs()
            self.STARTUP_MESSAGE = 'Starting 2055-Music...'
            self.STARTUP_COMPLETE_MESSAGE = '2055-Music is now operating.'
            ...
            self.LOOP_ALL_ON = f'{self.__emojis.ERROR} 2055-Music is looping all songs, use {configs.BOT_PREFIX}loop off to disable this loop first'
            self.LOOP_ONE_ON = f'{self.__emojis.ERROR} 2055-Music is looping one song, use {configs.BOT_PREFIX}loop off to disable this loop first'
            self.LOOP_ALL_ALREADY_ON = f'{self.__emojis.LOOP_ALL} 2055-Music is already looping all songs'
            self.LOOP_ONE_ALREADY_ON = f'{self.__emojis.LOOP_ONE} 2055-Music is already looping the current song'
